    ...
    ******************************/
    ...
    function displayProducts(){
        ...
        $.each(products, function(id, product){
            ...
            itemBox.innerHTML = '<ul><span class="discount">-' + discount + '%</span><li><a href="' + product.url + '"><img src="' + product.image + '"></a></li><li><span class="name">' + product.name + '</span></li><li>Pris: <span class="price">' + product.price + '</span>DKK (' + discount + '% off!)</li><li>Vejl. pris: <span class="price_old">' + product.price_old + '</span>DKK</li><li>Levering: ' + product.delivery + '</li><li><span class="sizes">Størrelse: ' + product.sizes + '</span></li></ul>';
